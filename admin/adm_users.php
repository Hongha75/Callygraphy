...
<body>
    <div id="wrapper">
        <div class="header">
            <nav class="container">
                <a href="../admin/admin.php" id="logo">
...
foreach($uList as $item) {
    echo '<tr>
            <td align="center"><a href="adm_edit.php?id='.$item['id'].'" class="btn btn-default"><em class="fa fa-pencil"></em></a> <a href="adm_delete.php?id='.$item['id'].'" class="btn btn-danger"><em class="fa fa-trash"></em></a></td> 
