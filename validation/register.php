        ...
        <div class="main-right">
            ...
            <div class="form-login-right">
               <form method="post">
                    ...
                    <ul>
                        <li>Full Name</li>
                        <li><input type="text" name="name"placeholder ="Eg: Phạm Tuấn Anh"></li>
                        <li>Email/Tài khoản Nhánh</li>
                        <li><input type="email" name="email" placeholder="Eg: phamtuananh2101@gmail.com"></li>
                        <li>Phone</li>
                        <li><input type="tel" name="phone" placeholder="Eg: 0836668336"></li>
                        <li>Password</li></li>
                        <li><input id="pass" name="pwd" type="password"></li>
                        <box-icon style="position:absolute;right:160px;top:625px; cursor: pointer;"onclick="myfunction()" name='low-vision'></box-icon>
